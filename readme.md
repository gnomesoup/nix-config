...
Currently this manages the PowerToys Keyboard Manager profile that remaps `Win+A/C/P/V/X/Z` to `Ctrl+A/C/P/V/X/Z` and `Win+1..9` to WezTerm's default `Ctrl+Shift+1..9` tab shortcuts. `Win+0` is not remapped.
